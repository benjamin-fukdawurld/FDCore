...
namespace FDCore
{
    ...
    class TimeManager
    {
      ...
      public:
        ...
        bool hasBeginTime() const { return m_beginTime.time_since_epoch().count() != 0; }

        bool hasLastTime() const { return m_lastTime.time_since_epoch().count() != 0; }
        ...
        void restart() { m_lastTime = m_beginTime = clock_type::now(); }

        void recordTime() { m_lastTime = clock_type::now(); }
