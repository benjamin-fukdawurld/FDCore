...
namespace FDCore
{
    ...
    /**
     * @brief ComparableTrait is a CRTP class that implements all comparison operators based on the
     * compare method of the Comparable class. The compare method must return a value that is
     * comparable with 0. If the result of a.compare(b) is 0 then a == b is true otherwise if the
     * result is < 0, a < b and if the result is greater than 0 a > b
     *
