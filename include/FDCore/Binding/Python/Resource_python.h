    ...
    namespace Python
    {
        ...
        class PYBIND11_EXPORT PyAbstractResource : public PyObject<ResourceBase>
        {
            public:
                ...
                bool load() override
                {
                    PYBIND11_OVERLOAD_PURE(bool, ResourceBase, load, );
                }
                ...
                {
                    PYBIND11_OVERLOAD_PURE(void, ResourceBase, release, );
                }
        };
        ...
        class PYBIND11_EXPORT PyResource : public PyAbstractResource<ResourceBase>
        {
            public:
                ...
                bool load() override
                {
                    PYBIND11_OVERLOAD(bool, ResourceBase, load, );
                }

                bool isLoaded() const override
                {
                    PYBIND11_OVERLOAD(bool, ResourceBase, isLoaded, );
                }

                void release() override
                {
                    PYBIND11_OVERLOAD(void, ResourceBase, release, );
                }
        };
