...
namespace FDCore
{
    class ResourceManager
    {
      public:
        ...
        struct ResourceLoader
        {
            ...
            bool matches(std::string_view path) const { return matcher(path); }

            resource_pointer load(std::string_view path) const { return loader(path); }
        };
    ...
    template<typename Predicate>
    ResourceManager::const_iterator ResourceManager::lower_bound(const_iterator first,
                                                                 const_iterator last,
    ...
    {
        const_iterator it =
          const_cast<const ResourceManager *>(this)->lower_bound(first, last, pred);
    ...
    template<class Predicate>
    ResourceManager::const_iterator ResourceManager::upper_bound(const_iterator first,
                                                                 const_iterator last,
                                                                 Predicate pred) const
    {
        const_iterator it;
