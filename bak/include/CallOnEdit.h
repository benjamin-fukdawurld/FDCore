...
namespace FDCore
{
    ...
    class CallOnEdit
    {
      ...
      public:
        CallOnEdit() : CallOnEdit(nullptr) {}

        CallOnEdit(T *managed) : m_managed(managed) {}

        template<typename CallbackType>
        CallOnEdit(T *managed, CallbackType cb) : m_managed(managed), m_callback(cb)
        {
        }
        ...
        std::function<void(T &)> getCallback() const { return m_callback; }
        ...
        void setManagedObject(T *managed) { m_managed = managed; }
